...
AirMe 以 Email 帳號作為 App／Web 產品入口；使用者完成註冊或登入後才建立「此裝置個人檔案」。本機暱稱不需真名，個人設定、日誌與回饋仍只保存在裝置端；帳號**不會**啟用雲端個人檔案、日誌或回饋同步。
...
- 必要帳號只保存 Email、顯示名稱、password hash、隱私同意與建立時間；不以 Email 連結本機 profile、回饋、日誌或環境查詢。
